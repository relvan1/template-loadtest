...
kubectl create -n $tenant -f $working_dir/templates/jmeter_influxdb_deploy.yaml

kubectl create -n $tenant -f $working_dir/templates/jmeter_influxdb_svc.yaml

echo "Creating Grafana Deployment"

kubectl create -n $tenant -f $working_dir/templates/jmeter_grafana_deploy.yaml

kubectl create -n $tenant -f $working_dir/templates/jmeter_grafana_svc.yaml
